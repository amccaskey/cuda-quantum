...
# CHECK:           %[[VAL_5:.*]] = quake.mx %[[VAL_3]] : (!quake.ref) -> i1
# CHECK:           %[[VAL_6:.*]] = quake.mx %[[VAL_4]] : (!quake.ref) -> i1
# CHECK:           %[[VAL_7:.*]] = quake.my %[[VAL_3]] : (!quake.ref) -> i1
# CHECK:           %[[VAL_8:.*]] = quake.my %[[VAL_4]] : (!quake.ref) -> i1
# CHECK:           %[[VAL_9:.*]] = quake.mz %[[VAL_3]] : (!quake.ref) -> i1
# CHECK:           %[[VAL_10:.*]] = quake.mz %[[VAL_4]] : (!quake.ref) -> i1
# CHECK:           return
# CHECK:         }
...
# CHECK:           %[[VAL_1:.*]] = quake.mx %[[VAL_0]] : (!quake.veq<3>) -> !cc.stdvec<i1>
# CHECK:           %[[VAL_2:.*]] = quake.my %[[VAL_0]] : (!quake.veq<3>) -> !cc.stdvec<i1>
# CHECK:           %[[VAL_3:.*]] = quake.mz %[[VAL_0]] : (!quake.veq<3>) -> !cc.stdvec<i1>
# CHECK:           return
# CHECK:         }
