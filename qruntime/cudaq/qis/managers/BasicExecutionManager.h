...
// namespace details {
// template <class T>
// class ExecutionManager_impl : public ExecutionManager {
// public:
//   using ExecutionManager::ExecutionManager;
...
// };
// template <class T>
// const bool ExecutionManager_impl<T>::registered_ =
//     ExecutionManager_impl<T>::register_type();
// } // namespace details
...
protected:
  static inline bool register_type() {
    auto &registry = get_registry();
    registry[Derived::class_identifier] = Derived::create;
    return true;
  }
