...
class DefaultQPU : public cudaq::details::QPU_impl<DefaultQPU> {
public:
  DefaultQPU() = default;
...
class DefaultQuantumPlatform
    : public cudaq::details::quantum_platform_impl<DefaultQuantumPlatform> {
public:
  ...
  void setTargetBackend(const std::string &backend) override {
    ...
    for (auto &line : lines) {
      if (line.find(platformQPU) != std::string::npos) {
        ...
        platformQPUs.clear();
        platformQPUs.emplace_back(cudaq::QPU::get(qpuName));
