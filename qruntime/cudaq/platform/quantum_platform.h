...
#include "cudaq/utils/ObserveResult.h"
...
class quantum_platform : public cudaq::extension_point<quantum_platform> {
public:
...
CUDAQ_DEFINE_EXTENSION_IMPL(quantum_platform)
#define CUDAQ_REGISTER_PLATFORM(TYPE, NAME)                                          \
  static inline const std::string class_identifier = #NAME;                    \
  static std::unique_ptr<quantum_platform> create() {                          \
