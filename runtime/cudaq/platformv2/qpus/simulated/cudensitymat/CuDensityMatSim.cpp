...
class CuDensityMatSim : public cudaq::CircuitSimulatorBase<double> {
private:
...
protected:
  ...
  using cudaq::CircuitSimulatorBase<ScalarType>::tracker;
  using cudaq::CircuitSimulatorBase<ScalarType>::nQubitsAllocated;
  using cudaq::CircuitSimulatorBase<ScalarType>::stateDimension;
  using cudaq::CircuitSimulatorBase<ScalarType>::calculateStateDim;
  using cudaq::CircuitSimulatorBase<ScalarType>::executionContext;
  using cudaq::CircuitSimulatorBase<ScalarType>::gateToString;
  using cudaq::CircuitSimulatorBase<ScalarType>::x;
  using cudaq::CircuitSimulatorBase<ScalarType>::flushGateQueue;
  using cudaq::CircuitSimulatorBase<ScalarType>::previousStateDimension;
  using cudaq::CircuitSimulatorBase<ScalarType>::shouldObserveFromSampling;
  using cudaq::CircuitSimulatorBase<ScalarType>::summaryData;
...
public:
  ...
  cudaq::CircuitSimulator *clone() override {
    thread_local static std::unique_ptr<CircuitSimulator> simulator =
        std::make_unique<CuDensityMatSim>();
    return simulator.get();
  }
  CUDAQ_EXTENSION_CREATOR_FUNCTION_WITH_NAME(dynamics, CircuitSimulator,
                                             CuDensityMatSim)
};
} // namespace

CUDAQ_REGISTER_EXTENSION_TYPE(CuDensityMatSim)
