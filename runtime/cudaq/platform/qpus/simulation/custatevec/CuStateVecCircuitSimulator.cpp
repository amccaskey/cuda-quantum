...
public:
  CUDAQ_ADD_EXTENSION_CREATOR_FUNCTION_WITH_NAME(custatevec_fp32, CircuitSimulator,
                                             CuStateVecCircuitSimulatorF32)
};
CUDAQ_REGISTER_EXTENSION(CuStateVecCircuitSimulatorF32);

class CuStateVecCircuitSimulatorF64
    : public CuStateVecCircuitSimulator<double> {
public:
  CUDAQ_ADD_EXTENSION_CREATOR_FUNCTION_WITH_NAME(custatevec_fp64, CircuitSimulator,
                                             CuStateVecCircuitSimulatorF64)
};

CUDAQ_REGISTER_EXTENSION(CuStateVecCircuitSimulatorF64);
